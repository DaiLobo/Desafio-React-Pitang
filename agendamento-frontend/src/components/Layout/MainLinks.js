...
const routes = [
    ...
    {icon: <CalendarEvent size={16} />, color: "teal", label: "Agendamento de Pacientes", path: "/agendamento"},
    {icon: <ClipboardList size={16} />, color: "violet", label: "Consulta dos Agendamentos", path: "/consulta"},    
]
